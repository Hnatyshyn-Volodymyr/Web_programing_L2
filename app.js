...
let ports = [
  new Port("Rotterdam", "Holland", 2234, "Rijndwarsweg", [33]),
...
let ships = [
  new Ship("49", 49, "Holland", 25, [
    new Log(12, new Date(2020, 10, 29), new Date(2020, 2, 17)),
    new Log(33, new Date(2021, 3, 30), new Date(2021, 7, 17)),
  ]),

  new Ship("Delphine", 33, "Great Britian", 10, [
    new Log(12, new Date(2020, 10, 29), new Date(2020, 2, 17)),
    new Log(2, new Date(2021, 3, 30), new Date(2021, 7, 17)),
  ]),
